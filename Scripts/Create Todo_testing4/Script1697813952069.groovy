...
def nameValue = findTestData('MST/DataInput').getValue('Name',4)

def calendarValue = findTestData('MST/DataInput').getValue('Date',4) //2023-08-01
...
def typeValue = findTestData('MST/DataInput').getValue('Type',4)

def descriptionValue = findTestData('MST/DataInput').getValue('Description',4)
