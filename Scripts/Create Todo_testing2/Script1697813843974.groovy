...
def nameValue = findTestData('MST/DataInput').getValue('Name',2)

def calendarValue = findTestData('MST/DataInput').getValue('Date',2) //2023-08-01
...
def typeValue = findTestData('MST/DataInput').getValue('Type',2)

def descriptionValue = findTestData('MST/DataInput').getValue('Description',2)
