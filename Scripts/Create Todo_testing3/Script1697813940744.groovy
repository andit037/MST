...
def nameValue = findTestData('MST/DataInput').getValue('Name',3)

def calendarValue = findTestData('MST/DataInput').getValue('Date',3) //2023-08-01
...
def typeValue = findTestData('MST/DataInput').getValue('Type',3)

def descriptionValue = findTestData('MST/DataInput').getValue('Description',3)
